      ...
      sortedArray: [
        {
          ...
          src: require('../assets/BlogImage_6.jpg'),
          alt: 'photo',
          ...
          secondsrc: require('../assets/BlogImage_8.jpg')
        }
      ],
      numbersandtexts: [
        {
      ...
      articles: [
        {
          ...
          thirdnumber: '3',
          fourthpargth: 'Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.',
          secondsrc: require('../assets/BlogImage_2.jpg')
        },
        {
          id: 'bedroom',
          ...
          thirdnumber: '3',
          fourthpargth: 'Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.',
          secondsrc: require('../assets/BlogImage_4.jpg')
        },
        {
          id: 'building',
          ...
          thirdnumber: '3',
          fourthpargth: 'Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.',
          secondsrc: require('../assets/BlogImage_6.jpg')
        },
        {
          id: 'architecture',
          ...
          thirdnumber: '3',
          fourthpargth: 'Contrary to popular belief.There are many variations of passages of Lorem Ipsum available, but the majority have suffered.',
          secondsrc: require('../assets/BlogImage_1.jpg')
        },
        {
          id: 'kitchen-planning',
